...
namespace Elicon.Domain.GateLevel.Reports.CountNativeModules
{
    ...
    {
        IList<NativeModuleCount> CountNativeModules(string netlist, string rootModule);
    }
    ...
    public class CountNativeModulesQuery : ICountNativeModulesQuery
    {
        ...
        public IList<NativeModuleCount> CountNativeModules(string netlist, string rootModule)
        {
